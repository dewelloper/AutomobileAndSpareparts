...
//                    return "The authentication provider returned an error. Please verify your entry and try again. If the problem persists, please iletisim your system administrator.";

//                case MembershipCreateStatus.UserRejected:
//                    return "The user creation request has been canceled. Please verify your entry and try again. If the problem persists, please iletisim your system administrator.";

//                default:
//                    return "An unknown error occurred. Please verify your entry and try again. If the problem persists, please iletisim your system administrator.";
//            }
//        }
//        #endregion
...
//                {
//                    return Json(new
//                    { success = true, redirect = returnUrl });
//                }
//                var user = membershipService.GetUser(model.UserName);
//                if (user == null)
//                {
