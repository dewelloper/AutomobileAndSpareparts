    ...
    $.fn.btsListFilter = function (inputEl, options) {
        ...
        inputEl$.on(options.eventKey, debouncer(function (e) {
            ...
            if (val !== '' && val.length >= options.minLength) {
                contains.removeClass('lnkHide').addClass('lnkShow').show();
                contains.parent('.list-group').addClass('grpShow');
                containsNot.removeClass('lnkShow').hide();
                ...
                contains.removeClass('lnkShow').show();
                containsNot.removeClass('lnkShow').show();
                searchlist$.find('.bts-dynamic-item').remove();
            }
        }, options.delay));
